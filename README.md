...
<!-- PERFORMANCE:START -->
**Since 2026-07-16 (current live system):** Account **+2.30%** vs SPY **+0.87%** (outperforming SPY by 1.43pp)
**All-time, net of all deposits/withdrawals:** **+0.67%**

_Last updated: 2026-09-01 19:30 UTC — percentage returns only, position size/equity not disclosed._
<!-- PERFORMANCE:END -->
