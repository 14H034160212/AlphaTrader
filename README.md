...
<!-- PERFORMANCE:START -->
**Since 2026-07-16 (current live system):** Account **+3.30%** vs SPY **+1.86%** (outperforming SPY by 1.44pp)
**All-time, net of all deposits/withdrawals:** **+1.65%**

_Last updated: 2026-08-28 17:30 UTC — percentage returns only, position size/equity not disclosed._
<!-- PERFORMANCE:END -->
