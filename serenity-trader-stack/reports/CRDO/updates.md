...
- **付费深度判断** ($0.4992): **Ollama 状态核实**: 11435 端口 gemma4:31b 正常在线响应,两路"分析失败"是已知的 crossvalidate 脚本 120s 超时 vs 冷启动误报模式(见 [[project_ollama_crossvalidate_false_positive]]),**不是真实的模型宕机**,本次升级是假信号。

## 综合判断

**论文依然成立,且本周基本面进一步走强**:
- 7/6 单日暴涨~13%($242→$273,盘中触及$280.5),逼近52周高点$308.67,分析师目标价集体上调(Evercore $325、Stifel $350、BofA $340),18家买入0家卖出——动量比建仓时($257.6)更强,不是走弱。
- **最大风险点(客户集中度)本周不是恶化而是改善**:最新季度前三大客户占比34%/27%/16%,叠加第四、五家超10%的超大规模客户,呈现"公司主动多元化"而非"客户砍单"的信号——证伪清单里的头号触发条件(集中度进一步恶化)本周反而走向反方向。
- 唯一值得记录的风险信号:CEO/CFO/CTO等高管6月有减持(套现而非清仓),以及部分空头文章(Seeking Alpha)开始提"估值过高+三客户集中"的看空论点——现价已略高于分析师平均目标价,估值不再便宜。
...
- **升级触发**: 本地 Ollama 分析失败(两路都返回空)— 无法交叉验证,人工确认模型是否在线
- **付费深度判断** ($0.4602): ## CRDO 综合判断(本地双框架均为已知假阳性,不计入证伪证据)

**论文依然成立,且强化**。公开信息核实(2026-07-06/07)显示:Evercore ISI 首次覆盖给出 Outperform + $325目标价,Stifel上调至$350,BofA上调至$340——均显著高于建仓时的分析师均值$269.81,说明华尔街对"质量成长动量"论文在追认而非证伪。基本面端毛利率仍维持68%附近,单季营收约$4.37亿,净利润$1.69亿,盈利质量未见恶化。

**客户集中度风险未恶化、反而边际改善**:FY26 10-Q显示前十大客户占营收约90%,但已有两个客户各占比≥10%(此前疑似Amazon单一客户占比48-84%),说明客户结构正在从"单点依赖"向"双点依赖"分散,证伪清单里"集中度进一步恶化且无对冲"这条目前不成立。唯一需要留意的是6月出现内幕人士集群性减持(CEO/CFO/CTO/CLO及一名董事仍保留大部分持股),这是常规套现兑现而非管理层信心崩塌的信号,但值得记入观察清单。

**建议: HOLD**。没有任何一条证伪信号被触发,分析师目标价上修反而说明论文被市场进一步验证;卫星仓8.7%仓位内,不建议因本地Ollama交叉验证空返回(已知是超时假阳性,详见你的历史记录`project_ollama_crossvalidate_false_positive`)而做任何减仓动作。下次财报重点核实客户集中度是否真的降到"双客户"结构以及有无新客户对冲信号出现。

Sources:
- [CRDO Stock Draws Aggressive Price Targets](https://stockstotrade.com/news/credo-technology-group-holding-ltd-crdo-news-2026_07_06-3/)
- [CRDO Stock Draws Bullish Targets](https://www.timothysykes.com/news/credo-technology-group-holding-ltd-crdo-news-2026_07_06/)
- [CRDO Stock Draws Aggressive Price Targets As Insiders Trim Stakes](https://www.timothysykes.com/news/credo-technology-group-holding-ltd-crdo-news-2026_07_06-2/)
- [Credo Technology Group Holding Ltd - Form 10-Q FY2026](https://www.sec.gov/Archives/edgar/data/0001807794/000162828026014017/crdo-20260131.htm)
