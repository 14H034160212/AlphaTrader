"""
SerenityAlphaTrader RL LoRA Trainer (Path 2)
=====================================
Fine-tunes Qwen3.5-35B-A3B (MoE) with LoRA adapters using reward-weighted SFT
on SerenityAlphaTrader's real trading P&L data.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SerenityAlphaTrader RL LoRA Trainer")
